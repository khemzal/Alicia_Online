...
### Github 
Most users do have Github installed and are logged in. However, if not, create an account on github.com and run the downloader installer from https://desktop.github.com/download/. Make sure add GIT to Path is enabled. You can check by running Powershell and typing ```git --version```
